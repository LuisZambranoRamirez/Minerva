...
public final class SaleIdImpl extends ValueObject<UUID> implements SaleId {
    ...
    public static SaleIdImpl fromString(String value) throws InvalidDomainArgumentException {
        if (value == null || value.isBlank()) {
            throw new InvalidDomainArgumentException("El ID de la venta no puede estar vacío.");
        }
        ...
        try {
            ...
            throw new InvalidDomainArgumentException(
                    "El ID de la venta no tiene un formato UUID válido.",
                    e
            );
        }
    }
