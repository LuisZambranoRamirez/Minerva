...
public class Markup extends ValueObject<Markup.Value> {
    ...
    public Markup(BigDecimal amount, GainStrategy gainStrategy) throws InvalidDomainArgumentException {
        super(validatedValue(amount, gainStrategy));
    }

    private static Value validatedValue(BigDecimal amount, GainStrategy gainStrategy)
        ...
        return new Value(amount, gainStrategy);
    }
